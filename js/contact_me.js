        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    $('#success-mail > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success-mail > .alert-danger').append("<strong>Désolé " + firstName + ", il semble que le serveur mail ne soit pas disponible. Réessayez plus tard !");
                    $('#success-mail > .alert-danger').append('</div>');
                    //clear all fields
                    $('#contactForm').trigger("reset");
                },
            })
